...
select d.name,o.order_id,r.r_name,f.f_name,o.date
...
select r.r_id,r.r_name,count(*) as loyal_customer
from
(
...
select months,((rev-prev_rev)/prev_rev)*100 as groth_percentage from(
with chb as
(
